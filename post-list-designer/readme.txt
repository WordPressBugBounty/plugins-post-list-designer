...
1. Post List Design 1
2. Post List Design 2
3. Post List Simple Design
4. Post List Archive Design
...
= 3.3.3 (10 Mar, 2024) =
* [*] Fixed Cross-Site Scripting vulnerability with `title_tag` and `list_style` parameter.
...
= 2.1.2 (14 Sep, 2020) =
* [*] Added category slug support for shortcode parameter : category. Now you can use like this category="5" OR category="tech" where category name is Tech, id is 5 an slug name is tech.

= 2.1.1 (08 Sep, 2020) =
* [*] Tested up to: 5.5

= 2.1 (29 July, 2020) =
* [+] Added: Added 2 new shortcode parameters order and order by.
